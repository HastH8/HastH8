...
<table>
  <tr>
    <td width="60%" valign="top">
      <h3>Focus</h3>
      <ul>
        <li>Owner + full-time developer at UiForge FiveM Store and Coderanch RedM Store</li>
        <li>Full-stack software engineering with TypeScript, React, and Node.js</li>
      ...
      <ul>
        <li>Owner + full-time dev: UI/UX and storefront systems at <a href="https://uiforge.tebex.io">UiForge FiveM Store</a></li>
        <li>Owner + full-time dev: scripts, tooling, and pipelines for <a href="https://coderanch-red.tebex.io">Coderanch RedM Store</a></li>
